      ...
      <footer class="text-gray-700">
        ...
        <div className="bg-[#192132] ">
          <div class=" max-w-screen-xl px-4 py-16 mx-auto sm:px-6 text-gray-300 lg:px-8  w-[100%]">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
              <div>
                ...
                <p class="max-w-xs mt-4 text-sm text-gray-500 ">
                  Origgin Ltd <br /> Boundary Road 3,
                  <br /> East Legon, Accra. <br />
                  Ghana, West Africa.
                </p>

                <p className="text-gray-500 hover:text-red-300 transition-colors pt-5">
                  <a
            ...
            <p class=" text-md text-gray-500 flex text-center justify-center border-t-1 outline-gray-900 pt-5 mt-12 ">
              © 2024 All Rights Reserved, Origgin Ltd.
            </p>
          </div>
        </div>
      </footer>
