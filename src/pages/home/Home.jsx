...
const Home = () => {
  return (
    <>
      {/* <Head>
        <title>ORIGGIN - Voice-Enabled Electricity Prepaid App</title>
        <meta
          name="description"
          content="Buy electricity prepaid credit quickly and conveniently using just your voice with ORIGGIN"
        />
      </Head> */}
        ...
        <section className="my-20">
          <div className="container mx-auto px-4">
            <div className="text-center mx-auto mb-12 lg:mb-20 max-w-3xl">
              <div className="font-semibold text-primary space-y-6">
                ...
                <div className="text-3xl md:text-4xl flex justify-center items-center gap-3">
        ...
        <section className="py-10">
          <div className="container mx-auto px-4">
            <p className="mx-auto text-base md:text-lg text-center max-w-2xl text-gray-600 leading-relaxed mb-8">
              ...
              buying electricity prepaid credit quick, simple and convenient.
              With Origgin you can top up your prepaid meter instantly — all by
              using your voice.
            </p>
